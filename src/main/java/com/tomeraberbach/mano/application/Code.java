...
public class Code implements ChangeListener<String> {
  ...
  /**
   * Saves the code document text found in the text area in {@link Code#tab} to a {@link File}
   * choosen by the user.
   *
   * @param stage {@link Stage} where this {@link Code} is being displayed.
   * @return boolean representing if this {@link Code} was successfully saved.
  ...
  /**
   * Called when text in the code document's {@link Code#tab} was changed. Adds an asterisk to the
   * code document's {@link Tab} title to indicate it has unsaved changes.
   *
  ...
  @Override
  public void changed(
      ObservableValue<? extends String> observableValue, String old, String current) {
