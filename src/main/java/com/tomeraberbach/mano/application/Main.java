...
public class Main extends Application {
  ...
  public static final KeyCombination SAVING =
      new KeyCodeCombination(KeyCode.S, KeyCombination.CONTROL_DOWN);

  /** {@link KeyCombination} for assembling. */
  public static final KeyCombination ASSEMBLING =
  ...
  /**
   * Called when the 'New' button is pressed. Initializes a new instance of {@link Code} with {@link
   * Code#Code()}, adds it to {@link Main#codes}, and displays it in {@link Main#codesFX}.
   */
  @FXML
  ...
  /**
   * Called when the 'Open...' button is pressed. Creates a prompt to choose a file to open. If a
   * {@link File} was picked initializes a new instance of {@link Code} with {@link
   * Code#Code(File)}.
   */
  @FXML
  ...
  /**
   * Called when the 'Close' button is pressed. If {@link Main#codesFX} contains any tabs it closes
   * the currently selected {@link Code} document. It will prompt the user to save the {@link Code}
   * document if there have been unsaved changes.
   */
  @FXML
  ...
  /**
   * Called when the 'Save' button is pressed. If {@link Main#codesFX} contains any tabs it saves
   * the currently selected {@link Code} document. If the selected {@link Code} document does not
   * have a file it passes off the job to {@link Main#saveAsOnAction()}. Otherwise it saves the
   * {@link Code} document with {@link Code#save(Stage)}.
   */
  @FXML
  ...
  /**
   * Called when the 'Save All' button is pressed. If {@link Main#codesFX} contains any tabs it
   * saves all of the {@link Code} documents. Otherwise it saves the {@link Code} document with
   * {@link Code#save(Stage)}.
   */
  @FXML
  ...
  /**
   * Called when the 'Save as...' button is pressed. If {@link Main#codesFX} contains any tabs it
   * displays a prompt for choosing where to save the current {@link Code} document. If a {@link
   * File} is chosen will be called followed by a call to {@link Code#saveAs(Stage)}.
   */
  @FXML
  ...
  /**
   * Called when the 'Assemble' button is pressed. Compiles the currently selected tab's assembly
   * code in {@link Main#codes} using {@link Compiler}. Logs any errors in {@link Main#consoleFX}.
   */
  @FXML
  ...
  /**
   * Called when the 'Assemble All' button is pressed. Compiles all the assembly code in {@link
   * Main#codes} using {@link Compiler}. Logs any errors in {@link Main#consoleFX}.
   */
  @FXML
  ...
  /** Called when the 'About Mano Simulator' button is pressed. Opens an about window. */
  @FXML
  ...
  /** Called when the '?' button is pressed. Opens a help window for input. */
  @FXML
  ...
  private void exportOnAction() {
    ...
    Alert alert =
        new Alert(
            Alert.AlertType.INFORMATION,
            "",
            new ButtonType("Copy to Clipboard", ButtonBar.ButtonData.OTHER));
    alert.setTitle("RAM");
   ...
   * @throws IOException Occurs when the file 'main.fxml' representing the layout of the application
  ...
  /** Called when the 'Quit' button is pressed. Alerts the user about any unsaved code. */
  @FXML
