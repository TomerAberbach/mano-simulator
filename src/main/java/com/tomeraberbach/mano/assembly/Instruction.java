...
public class Instruction {
  /**
   * Maps memory referencing assembly instruction lexemes to their respective codes. This does not
   * include directives.
   *
  ...
  /**
   * The amount which must be added to a direct addressing assembly instruction's code so that it
   * becomes an indirect addressing assembly instruction.
   */
   ...
   * @param tokens Array of {@link Token} instances which represented this {@link Instruction} in
   *     source code.
   */
  ...
  /**
   * @return {@link Instruction} which is identical to this {@link Instruction} except {@link
   *     Instruction#code} is offset by {@link Instruction#INDIRECT_ADDRESSING_OFFSET}.
   */
   ...
   * @return {@link Instruction} which is identical to this {@link Instruction} except {@link
   *     Instruction#code} is offset by {@link Label#address}.
   */
