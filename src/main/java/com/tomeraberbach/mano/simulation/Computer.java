...
public class Computer {
  /**
   * The {@link Signal} instances used for determining the microoperations required for an
   * instruction.
   */
  ...
  public static final int MAX_SIZE =
      (int) Math.floor(Math.log(Integer.MAX_VALUE) / Math.log(2.0)) - 1;
  ...
  static {
    ...
    set.add(
        new Signal(
            new Control("R'T0", computer -> !computer.r.value(0) && computer.sc() == 0),
            new Microoperation("AR <- PC", computer -> computer.ar.load(computer.pc.value()))));

    set.add(
        new Signal(
            new Control("R'T1", computer -> !computer.r.value(0) && computer.sc() == 1),
            new Microoperation(
                "IR <- M[AR]",
    ...
    set.add(
        new Signal(
            new Control(
                "R'T1 + RT2 + D6T6(DR)' + D7I'T3(B4(AC(15))' + B3(AC(15)) + B2(AC)' + B1E') + D7IT3(B9(FGI) + B8(FGO))",
                computer -> // R'T1
            ...
            new Microoperation("PC <- PC + 1", computer -> computer.pc.increment())));

    set.add(
        new Signal(
            new Control("R'T2", computer -> !computer.r.value(0) && computer.sc() == 2),
            new Microoperation(
    ...
    set.add(
        new Signal(
            new Control("R'T2", computer -> !computer.r.value(0) && computer.sc() == 2),
            new Microoperation(
                "AR <- IR(0-11)", computer -> computer.ar.load(computer.ir.value(0, 11)))));

    set.add(
        new Signal(
            new Control("R'T2", computer -> !computer.r.value(0) && computer.sc() == 2),
            new Microoperation(
                "I <- IR(15)", computer -> computer.i.load(computer.ir.value(15) ? 1 : 0))));
            ...
            new Control(
                ...
                computer ->
                    computer.sc() != 0
                        && computer.sc() != 1
                        && computer.sc() != 2
                        && computer.ien.value(0)
                        && (computer.fgi.value(0) || computer.fgo.value(0))),
            new Microoperation("R <- 1", computer -> computer.r.load(1))));

    set.add(
        new Signal(
            new Control("RT0", computer -> computer.r.value(0) && computer.sc() == 0),
            new Microoperation("AR <- 0", computer -> computer.ar.clear())));

    set.add(
        new Signal(
            new Control("RT0", computer -> computer.r.value(0) && computer.sc() == 0),
            new Microoperation("TR <- PC", computer -> computer.tr.load(computer.pc.value()))));

    set.add(
        new Signal(
            new Control("RT1", computer -> computer.r.value(0) && computer.sc() == 1),
            new Microoperation(
                "M[AR] <- TR",
    ...
    set.add(
        new Signal(
            new Control("RT1", computer -> computer.r.value(0) && computer.sc() == 1),
            new Microoperation("PC <- 0", computer -> computer.pc.clear())));
        ...
        new Signal(
            new Control(
                ...
                (computer.r.value(0) && computer.sc() == 2)
                        ||
                        // p = D7IT3, pB6
                        (computer.decoder.value(7)
                            && computer.i.value(0)
                            && computer.sc() == 3
                            && computer.ir.value(6))),
            new Microoperation("IEN <- 0", computer -> computer.ien.clear())));

    set.add(
        new Signal(
            new Control("RT2", computer -> computer.r.value(0) && computer.sc() == 2),
            new Microoperation("R <- 0", computer -> computer.r.clear())));

    set.add(
        new Signal(
            new Control(
                "RT2 + D0T5 + D1T5 + D2T5 + D3T4 + D4T4 + D5T6 + D6T6 + D7I'T3 + D7IT3",
                computer -> // RT2
                (computer.r.value(0) && computer.sc() == 2)
                        ||
                        // D0T5
                        ...
                        // p = D7IT3
                        (computer.decoder.value(7) && computer.i.value(0) && computer.sc() == 3)),
            new Microoperation("SC <- 0", computer -> computer.sc.setValue(0))));
    ...
    set.add(
        new Signal(
            new Control("D0T5", computer -> computer.decoder.value(0) && computer.sc() == 5),
            new Microoperation("AC <- AC ^ DR", computer -> computer.ac.and(computer.dr.value()))));

    set.add(
        new Signal(
            new Control("D1T5", computer -> computer.decoder.value(1) && computer.sc() == 5),
            new Microoperation(
                "AC <- AC + DR", computer -> computer.ac.add(computer.dr.value(), computer.e))));

    set.add(
        new Signal(
            new Control("D2T5", computer -> computer.decoder.value(2) && computer.sc() == 5),
            new Microoperation("AC <- DR", computer -> computer.ac.load(computer.dr.value()))));

    set.add(
        new Signal(
            new Control("D3T4", computer -> computer.decoder.value(3) && computer.sc() == 4),
            new Microoperation(
                "M[AR] <- AC",
        ...
        new Signal(
            new Control(
                ...
                (computer.decoder.value(4) && computer.sc() == 4)
                        ...
                        // D5T6
                        (computer.decoder.value(5) && computer.sc() == 6)),
            new Microoperation("PC <- AR", computer -> computer.pc.load(computer.ar.value()))));

    set.add(
        new Signal(
            new Control("D5T4", computer -> computer.decoder.value(5) && computer.sc() == 4),
            new Microoperation(
                "M[AR] <- PC",
    ...
    set.add(
        new Signal(
            new Control("D5T5", computer -> computer.decoder.value(5) && computer.sc() == 5),
            new Microoperation("AR <- AR + 1", computer -> computer.ar.increment())));

    set.add(
        new Signal(
            new Control("D6T5", computer -> computer.decoder.value(6) && computer.sc() == 5),
            new Microoperation("DR <- DR + 1", computer -> computer.dr.increment())));

    set.add(
        new Signal(
            new Control("D6T6", computer -> computer.decoder.value(6) && computer.sc() == 6),
            new Microoperation(
                "M[AR] <- DR",
            ...
            new Control(
                ...
                computer ->
                    computer.decoder.value(7)
                        && !computer.i.value(0)
                        && computer.sc() == 3
                        && computer.ir.value(11)),
            new Microoperation("AC <- 0", computer -> computer.ac.clear())));
            ...
            new Control(
                ...
                computer ->
                    computer.decoder.value(7)
                        && !computer.i.value(0)
                        && computer.sc() == 3
                        && computer.ir.value(10)),
            new Microoperation("E <- 0", computer -> computer.e.clear())));
            ...
            new Control(
                ...
                computer ->
                    computer.decoder.value(7)
                        ...
                        && computer.sc() == 3
                        && computer.ir.value(9)),
            new Microoperation("AC <- (AC)'", computer -> computer.ac.complement())));
            ...
            new Control(
                ...
                computer ->
                    computer.decoder.value(7)
                        ...
                        && computer.sc() == 3
                        && computer.ir.value(8)),
            new Microoperation("E <- E'", computer -> computer.e.complement())));
            ...
            new Control(
                ...
                computer ->
                    computer.decoder.value(7)
                        ...
                        && computer.sc() == 3
                        && computer.ir.value(7)),
            new Microoperation("AC <- shr AC", computer -> computer.ac.shiftRight(computer.e))));
            ...
            new Control(
                ...
                computer ->
                    computer.decoder.value(7)
                        ...
                        && computer.sc() == 3
                        && computer.ir.value(6)),
            new Microoperation("AC <- shl AC", computer -> computer.ac.shiftLeft(computer.e))));
            ...
            new Control(
                ...
                computer ->
                    computer.decoder.value(7)
                        ...
                        && computer.sc() == 3
                        && computer.ir.value(5)),
            new Microoperation("AC <- AC + 1", computer -> computer.ac.increment())));
            ...
            new Control(
                ...
                computer ->
                    computer.decoder.value(7)
                        ...
                        && computer.sc() == 3
                        && computer.ir.value(0)),
            new Microoperation("S <- 0", computer -> computer.s.clear())));
            ...
            new Control(
                ...
                computer ->
                    computer.decoder.value(7)
                        ...
                        && computer.sc() == 3
                        && computer.ir.value(11)),
            new Microoperation("FGI <- 0", computer -> computer.fgi.clear())));
            ...
            new Control(
                ...
                computer ->
                    computer.decoder.value(7)
                        ...
                        && computer.ir.value(10)),
            new Microoperation(
                "OUTR <- AC(0-7)", computer -> computer.outr.load(computer.ac.value(0, 7)))));
            ...
            new Control(
                ...
                computer ->
                    computer.decoder.value(7)
                        ...
                        && computer.sc() == 3
                        && computer.ir.value(10)),
            new Microoperation("FGO <- 0", computer -> computer.fgo.clear())));
            ...
            new Control(
                ...
                computer ->
                    computer.decoder.value(7)
                        ...
                        && computer.sc() == 3
                        && computer.ir.value(7)),
            new Microoperation("IEN <- 1", computer -> computer.ien.load(1))));
  ...
  /**
   * Constructor which initializes this {@link Computer} with T = 0, cleared {@link RAM}, and all
   * {@link Register} instances cleared.
   */
  public Computer() {
   ...
   * @throws IllegalArgumentException Thrown if calling {@link Computer#isValidValue(int, int)}
   ...
   * @return Unsigned integer representing the maximum possible value representable by {@code size}
   *     bits.
   */
   ...
   * @throws IllegalArgumentException Thrown if calling {@link Computer#isValidSize(int)} results in
   *     {@code false}.
   */
  ...
  /**
   * @param digit Binary digit index to check the validity of in a binary representation consisting
   *     of {@code size} bits.
   * @param size Integer number of bits for which to check {@code digit} is a valid index of.
   * @throws IllegalArgumentException Thrown if calling {@link Computer#isValidDigit(int, int)}
   *     results in {@code false}.
   */
   ...
   *     of {@code size} bits.
   * @param size Integer number of bits for which to check {@code digit} is a valid index of.
   * @return boolean representing if {@code digit} is a valid binary digit index in a binary
   *     representation consisting of {@code size} bits.
   */
  ...
  /**
   * @param digit The least to most significant zero-based binary digit index of {@code value} to
   *     get.
   * @param value Integer value to get the {@code digit}th bit of.
   * @return boolean representing if the binary digit at index {@code digit} of {@code value} is a
   *     {@code 1}.
   */
        ...
        .forEach(
            instruction -> {
              ...
              ram.values()
                  ...
                  .setInstruction(
                      Arrays.stream(instruction.tokens())
                          .map(Token::lexeme)
                          .collect(Collectors.joining(" ")));
            });
    program
        .labels()
        .forEach(label -> ram.values().get(label.address()).setLabel(label.token().lexeme()));

    s.load(1);
  }

  /**
   * Resets this {@link Computer} to its initial state which was right after its instantiation using
  ...
  /**
   * Gets the next batch {@link Microoperation} instances to be executed and adds them to this
   * {@link Computer#microoperations}. {@link Computer#sc} is incremented at the end of this method.
   *
