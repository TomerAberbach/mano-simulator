...
public class Signal {
  ...
  /**
   * @param computer {@link Computer} that will be assessed by the {@link Control#test(Computer)} of
   *     this {@link Signal#control}.
   * @return boolean representing if the {@code computer} meets the conditions of {@link
   *     Signal#control}.
   */
