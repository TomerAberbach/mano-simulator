...
public class Register {
  ...
  /**
   * Constructor which is the equivalent of calling {@link Register#Register(int)} with an argument
   * of {@code 1}.
   */
  public Register() {
    this(1);
  ...
  /**
   * {@code size} must pass {@link Computer#validateSize(int)} or an {@link
  ...
  /**
   * @param a The least to most significant zero-based binary digit index of this {@link
   *     Register#value} to start at.
   * @param b The least to most significant zero-based binary digit index of this {@link
   *     Register#value} to end at.
   * @return integer whose binary representation consists of binary digits on the interval [a, b] of
   *     this {@link Register#value}.
   */
  ...
  /**
   * {@code digit} must pass {@link Computer#validateDigit(int, int)} or an {@link
   * IllegalArgumentException} is thrown.
   *
   * @param digit The least to most significant zero-based binary digit index of this {@link
   *     Register#value} to get.
  ...
  /**
   * @return {@link StringBinding} representing {@link Register#value} as a hexadecimal {@link
   *     String}.
   */
  ...
  /**
   * {@code value} must pass {@link Register#validate(int)} or an {@link IllegalArgumentException}
   * is thrown.
   *
  ...
  /**
   * Shifts the bits in this {@link Register} and {@code e} left where {@code e} is considered to be
   * the most significant bit.
   *
   * @param e {@link Register} to load with the last bit in this {@link Register} and whose first
   *     bit will be loaded into the first bit of this {@link Register}.
   */
  ...
  /**
   * Shifts the bits in this {@link Register} and {@code e} right where {@code e} is considered to
   * be the most significant bit.
   *
   * @param e {@link Register} to load with the first bit in this {@link Register} and whose first
   *     bit will be loaded into the last bit of this {@link Register}.
   */
